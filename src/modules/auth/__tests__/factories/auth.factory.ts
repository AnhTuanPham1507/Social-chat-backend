...
export class AuthTestFactory {
  static createLoginPayload(overrides?: Partial<LoginPayloadDTO>): LoginPayloadDTO {
    return {
  ...
  static createRegisterPayload(overrides?: Partial<RegisterPayloadDTO>): RegisterPayloadDTO {
    return {
      fullName: 'Test User',
      email: 'test@example.com',
      password: 'TestPassword123!',
  ...
  static createGoogleLoginPayload(overrides?: Partial<GoogleLoginPayloadDTO>): GoogleLoginPayloadDTO {
    return {
      sub: 'google-user-123',
  ...
  static createAssetPayload(overrides?: Partial<CreateAssetPayloadDTO>): CreateAssetPayloadDTO {
    return {
      fileName: 'avatar.jpg',
